import unittest
from src.find_number import find_number

class TestLab1(unittest.TestCase):
    def test_findNumber1(self):
        result = find_number([15, 7, 22, 9, 36, 2, 42, 18], 3)
    ...
    def test_findNumber2(self):
        result = find_number([15, 17, 22, 9, 26, 12, 42, 18], 2)
    ...
    def test_findNumber3(self):
        result = find_number([16, -1, 9, 22, 30, 37, 5, -9, 3, 38], 5)
    ...
    def test_findNumber4(self):
        result = find_number([3, 5, 2, 15, 12, 5, 2, 5, 2, 18, 42, 4, 7], 4)
